...
ames %>%  sample_n(size = 50) %>% summarise(x_bar = mean(price))
```
...
```{r price-sampling}
# type your code for this Exercise here, and Run Document
sample_means50 = ames %>% rep_sample_n(size = 50, reps = 5000, replace = TRUE) %>% summarise(x_bar = mean(price))
...
# type your code for this Exercise here, and Run Document
sample_means150 = ames %>% rep_sample_n(size = 150, reps = 5000, replace = TRUE) %>% summarise(x_bar = mean(price))
...
# type your code for this Exercise here, and Run Document
price_sample15 = ames %>% sample_n(size = 15) %>% summarise(x_bar = mean(price))
```
...
sample15_means2000 = price_sample15 %>% rep_sample_n(size = 1, reps = 2000, replace = TRUE) %>% summarise(x_bar = mean(price))
ggplot(data = sample15_means2000, aes(x = x_bar)) + geom_histogram(binwidth = 2000)
```
...
# type your code for this Exercise here, and Run Document
price_sample150 = ames %>% sample_n(size = 150)
sample150_means2000 = price_sample150  %>% rep_sample_n(size = 1, reps = 2000, replace = TRUE) %>% summarise(x_bar = mean(price))
ggplot(data = sample150_means2000, aes(x = x_bar)) + geom_histogram(binwidth = 2000)
```
